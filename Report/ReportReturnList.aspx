<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportReturnList.aspx.cs"
    Inherits="Report_ReportReturnList" %>
            ...
            <div>
                <asp:Panel ID="SearchPanel" runat="server">
                    ...
                    <div style="float: right">
                        ...
                        <asp:LinkButton ID="lnkbtn_Add" runat="server" CausesValidation="False" Visible="false" CssClass="btn btn-primary"
                ...
                <asp:GridView ID="gv" runat="server" AllowPaging="True" CssClass="table table-hover "
                    ...
                    <Columns>
                        <asp:TemplateField HeaderImageUrl="~/images/edit.gif">
                            <ItemTemplate>
                                <asp:Button ID="cmd_Edit" runat="server" Text="回報" class="btn btn-mini" onmouseover="this.className='btn btn-mini'"
