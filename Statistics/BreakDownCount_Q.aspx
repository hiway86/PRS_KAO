<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BreakDownCount_Q.aspx.cs" Inherits="Statistics_BreakDownCount_Q"  %>
                    ...
                    <asp:Panel ID="SearchPanel" runat="server">
                        <div style="float: left">
                            ...
                            <asp:DropDownList ID="ddlst_SearchType" runat="server" CssClass="dropdown span2">
                                <asp:ListItem Value="DeviceID">設備編號</asp:ListItem>
                                <asp:ListItem Value="Counts">損壞次數</asp:ListItem>
                                <asp:ListItem Value="Device_Kind">設備種類</asp:ListItem>
                                <asp:ListItem Value="AreaName">地區</asp:ListItem>
                                <asp:ListItem Value="Location">路段</asp:ListItem>
                               <%-- <asp:ListItem Value="Gis_X">經度</asp:ListItem>
                                <asp:ListItem Value="Gix_Y">緯度</asp:ListItem>--%>
                            </asp:DropDownList>
                           
                            <asp:TextBox ID="txt_Query_Reason" runat="server" AutoCompleteType="Disabled" Width="200px"
                                placeholder="請輸入"></asp:TextBox> 
                            通報時間：
                            <asp:TextBox ID="txt_startDateTime" runat="server"  placeholder="通報時間查詢" CssClass="span2"></asp:TextBox><img src="../images/calendar.png" />
                            <asp:TextBox ID="txt_endDateTime" runat="server" placeholder="通報時間查詢" CssClass="span2"></asp:TextBox><img src="../images/calendar.png" />
                        </div>
                    ...
                    <div>
                        <asp:GridView ID="gv" runat="server" AllowPaging="True" CssClass="table table-hover  "
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Device_Kind" HeaderText="設備種類" />
                                <asp:BoundField DataField="AreaName" HeaderText="地區" />
                                <asp:BoundField DataField="Location" HeaderText="路段" />
                                <asp:BoundField DataField="ContractName" HeaderText="合約" />
                               <%-- <asp:BoundField DataField="Gis_X" HeaderText="經度" />
                                <asp:BoundField DataField="Gis_Y" HeaderText="緯度" />--%>
                            </Columns>
