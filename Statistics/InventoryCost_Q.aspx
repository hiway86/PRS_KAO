<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InventoryCost_Q.aspx.cs" Inherits="Statistics_InventoryCost_Q" %>
                    ...
                    <div>
                        <asp:GridView ID="gv" runat="server" AllowPaging="True" CssClass="table table-hover  "
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="stockincost" HeaderText="入庫成本" />
                                <asp:BoundField DataField="stockoutcost" HeaderText="出庫成本" />
                                <asp:BoundField DataField="analysisCost" HeaderText="損益成本" />
                            </Columns>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:Chart ID="Chart1" runat="server" Width="900px">
                        <Series>
                            <asp:Series Name="入庫成本" Legend="Legend1"></asp:Series>
                            <asp:Series Name="出庫成本" Legend="Legend2"></asp:Series>
                            <asp:Series Name="損益成本" Legend="Legend3"></asp:Series>
                        </Series>
                        <ChartAreas>
