<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeFile="BreakDownReason_Q.aspx.cs" Inherits="Statistics_BreakDownReason" %>
                    ...
                    <asp:Panel ID="SearchPanel" runat="server">
                        <div style="float: left">
                            ...
                            <asp:DropDownList ID="ddlst_SearchType" runat="server" CssClass="dropdown span2">
                                <asp:ListItem Value="FaultDescribe">損壞描述</asp:ListItem>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                        <asp:Chart ID="Chart1" runat="server" Width="900px" Height="300px">
                            <%--<titles>
								<asp:Title  ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 14.25pt, style=Bold" ShadowOffset="3" Text="故障因素統計" Name="Title1" ForeColor="26, 59, 105"></asp:Title>
							</titles>--%>
                            <legends>
