<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockOut_QD.aspx.cs" Inherits="Inventory_StockOut_QD" %>
                            ...
                            <div>
                                <fieldset>
                                    ...
                                    <asp:GridView ID="gv_stockOutitem" runat="server" AllowPaging="True" CssClass="table table-hover  "
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="StockOutItemID" HeaderText="出庫單序號" />
                                            <asp:BoundField DataField="StockOutID" HeaderText="出庫單編號" />
                                            <asp:BoundField DataField="MaterialID" HeaderText="物料編號" />
                                            <asp:BoundField DataField="MaterialName" HeaderText="物料名稱" />
                                            <asp:BoundField DataField="MaterialUnit" HeaderText="單位" />
                                            ...
                                            <asp:BoundField DataField="StockOutUse" HeaderText="用途" />
