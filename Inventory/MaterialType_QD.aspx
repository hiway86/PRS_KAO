<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialType_QD.aspx.cs" Inherits="Inventory_MaterialType_QD" %>
                ...
                <asp:UpdateProgress ID="UpdateProgress1" runat="server" DisplayAfter="2">
                    ...
                    <asp:GridView ID="gv" runat="server" AllowPaging="True" CssClass="table table-hover"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="MaterialTypeID" HeaderText="耗材編碼" ReadOnly="True" />
                            <asp:BoundField DataField="MaterialTypeName" HeaderText="耗材種類名稱" ReadOnly="True" />
