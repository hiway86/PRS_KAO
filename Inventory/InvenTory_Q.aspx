<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvenTory_Q.aspx.cs" Inherits="Inventory_Default" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" GridLines="None" AutoGenerateColumns="False"
                CellPadding="4" CellSpacing="1" DataKeyNames="MaterialID" CssClass="table table-hover " Width="100%" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit">
                <Columns>
