<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InventoryReview_AM.aspx.cs" Inherits="Inventory_InventoryReview_AM" %>
    ...
    <div class="container">
        ...
        <!--end-->        
         ...
         <label class="control-label">
                耗材名稱</label>
            <div class="controls">
                <asp:TextBox ID="txt_materialName" runat="server" AutoCompleteType="Disabled" CssClass="span3"
                    placeholder="請輸入"></asp:TextBox>
           </div>       
            <label class="control-label">
                庫存數量</label>
            <div class="controls">
                <asp:TextBox ID="txt_stockQuantity" runat="server" AutoCompleteType="Disabled" CssClass="span3"
                    placeholder="請輸入"></asp:TextBox>
            </div>
        </div>
