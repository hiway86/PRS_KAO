<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KindsOfEquipmentManage.aspx.cs" Inherits="MIS_KindsOfEquipmentManage" %>
...
<body>
    <form id="form1" runat="server" enctype="multipart/form-data" class="form-signin form-horizontal-50">
        <div>
        ...
        <div class="container">
            ...
            <div class="control-group">
                <label class="control-label">
                    設備種類編號</label>
                <div class="controls">
                    <asp:TextBox ID="txt_equipmentKindId" runat="server" AutoCompleteType="Disabled" CssClass="span3"
                        placeholder="請輸入"></asp:TextBox>
                </div>
                <label class="control-label">
                    設備種類</label>
                <div class="controls">
                    <asp:TextBox ID="txt_equipmentKind" runat="server" AutoCompleteType="Disabled" CssClass="span3"
                        placeholder="請輸入"></asp:TextBox>
                </div>
                <label class="control-label">
                    設備種類名稱</label>
                <div class="controls">
                    <asp:TextBox ID="txt_DeviceKindName" runat="server" AutoCompleteType="Disabled" CssClass="span3"
                        placeholder="請輸入"></asp:TextBox>
                </div>
                <label class="control-label>設備代表圖示</label>
                <div class="controls">
