<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegionManage.aspx.cs" Inherits="MIS_RegionManage" %>
    ...
    <div class="container">
        ...
        <!--end-->        
         ...
         <label class="control-label">
                地區編碼</label>
            <div class="controls">
                <asp:TextBox ID="txt_regionCode" runat="server" AutoCompleteType="Disabled" CssClass="span3"
                    placeholder="請輸入"></asp:TextBox>
           </div>       
            <label class="control-label"><b >*</b>
                地區</label>
            <div class="controls">
                <asp:TextBox ID="txt_region" runat="server" AutoCompleteType="Disabled" CssClass="span3"
                    placeholder="請輸入"></asp:TextBox>
            </div>
        </div>
